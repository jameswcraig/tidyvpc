...
* GROUP (medication type for stratification, "Concomitant", "No Concomitant")
...
Using multiple stratification variables `GENDER` and `GROUP`.
...
If using `binning()` methods, you can visualize bins by including the argument `show.stats = FALSE` in the `plot()`function.
